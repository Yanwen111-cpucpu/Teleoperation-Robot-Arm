...
def fk_1(theta):
    ...
    xi_2 = np.array([0,0,0,0,1,0])
    xi_3 = np.array([0,0,0,1,0,0])
    ...
    print('for question(c):')
    print('G_st(theta)=e^(xi_1_hat*theta_1)*e^(xi_2_hat*theta_2)*e^(xi_3_hat*theta_3)*G_st(0)')
...
def fk_2(theta):
    ...
    print('for question(b):')
    print('G_sb(theta)=e^(xi_1_hat*theta_1)*e^(xi_2_hat*theta_2)*e^(xi_3_hat*theta_3)*G_st(0)')
